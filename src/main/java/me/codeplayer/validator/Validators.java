...
public interface Validators {
	 ...
	 * format group
	 */
	Function<Object, String> trim = StringX::trim;
	Function<Object, String> toString = StringX::toString;
	...
	Predicate<String> assertIsNonNegative = NumberX::isNumeric;
	Predicate<Number> assertPositive = NumberX::isPositive;
	Predicate<Number> assertNonNegative = NumberX::isNonNegative;
