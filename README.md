# 关于 ready-x
ready-x ***3.x*** 是一个基于Java 8（ ***1.x*** 基于 Java 5，后续将推出全新的 Java 5 分支） 编写的基础工具库，其中包含了常见的文本(字符串)、数组、集合、文件、商业计算、随机数、参数验证、日期等方面的处理工具类。目前主要方便本人在工作中快速开发使用。
...
# 使用
本工具类库已发布至 Maven 中央仓库，当前最新版本为：**3.0.1-RELEASE** ，你可以通过如下 Maven 依赖配置引入本库：
